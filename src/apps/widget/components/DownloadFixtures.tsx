...
const DownloadFixtures = () => {
  ...
  return (
    <>
      <button
        data-tooltip-id="download-fixtures-tooltip"
        data-tooltip-content={`Download all mock API responses and drop the entire folder in your fixtures directory before running the test.`}
        onClick={download}
        disabled={disabled}
      ...
      <Tooltip id="download-fixtures-tooltip" className="cyw-text-xs" />
    </>
  );
};
